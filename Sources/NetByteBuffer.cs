...
namespace Buffalo.Kernel
{
    ...
    public class NetByteBuffer:IEnumerable<byte>,IDisposable
    {
        ...
        /// <returns></returns>
        public unsafe void AppendBytes(byte[] array, int sourceIndex,int length) 
        {
            CheckLength(length);
            ...
            {
                //fixed(byte* parry= array) 
                //{
                //    fixed (byte* pbuffer = _buffer)
                //    {
                //        Buffer.MemoryCopy(parry + sourceIndex, pbuffer + startIndex, length * sizeof(byte), length * sizeof(byte));
                //    }
                //}
            ...
            else//分段复制 
            {
                ...
                //    fixed (byte* pbuffer = _buffer)
                //    {
                //        Buffer.MemoryCopy( parry + sourceIndex,pbuffer + startIndex, leftLength * sizeof(byte), leftLength * sizeof(byte));

                //        Buffer.MemoryCopy( parry + partIndex, pbuffer, partLen * sizeof(byte), partLen * sizeof(byte));
                //    }
                //}
        ...
        public unsafe void ReadBytes(int sourceIndex, byte[] destinationArray, int destinationIndex, int length) 
        {
            ...
            {
                //fixed (byte* parry = destinationArray)
                //{
                //    fixed (byte* pbuffer = _buffer)
                //    {
                //        Buffer.MemoryCopy(pbuffer + index, parry + destinationIndex,  length * sizeof(byte), length * sizeof(byte));
                //    }
                //}
            ...
            else//分段读出
            {
                ...
                //    fixed (byte* pbuffer = _buffer)
                //    {
                //        Buffer.MemoryCopy(pbuffer + index, parry + destinationIndex, leftLength * sizeof(byte), leftLength * sizeof(byte));
                //        Buffer.MemoryCopy(pbuffer , parry + partIndex, partLen * sizeof(byte), partLen * sizeof(byte));
                //    }
                //}
