...
namespace NetClientDemo
{
    public partial class UCFastNet : UserControl
    {
        ...
        private void _conn_OnError(LibIOCP.DataProtocol.ClientSocketBase clientSocket, Exception ex)
        {
        ...
        private void _conn_OnReceiveData(LibIOCP.DataProtocol.ClientSocketBase socket, LibIOCP.DataProtocol.DataPacketBase data)
        {
            if (_conn != socket)
            {
                return;
